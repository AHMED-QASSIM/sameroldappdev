...
import 'package:smaergym/screens/admin/courses/select_exercise_screen.dart';

class SelectMuscle extends StatefulWidget {
  final int day;
  const SelectMuscle({super.key,required this.day});

  @override
  State<SelectMuscle> createState() => _ExcersiesState();
}

class _ExcersiesState extends State<SelectMuscle>
          ...
          builder: (ctx, index) {
            ...
            return GestureDetector(
              onTap: (){
                ...
                Get.to(SelectExerciseScreen(title: mucles[index]["name"],id:mucles[index]["id"],day: widget.day,));
