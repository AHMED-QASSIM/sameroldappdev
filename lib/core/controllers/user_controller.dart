...
class UserController extends GetxController {
    ...
    FirebaseAuth.instance.authStateChanges().listen((u) {
      ...
      FirebaseMessaging.instance.getToken().then((value) async {
        ...
        FirebaseFirestore.instance
            .collection("users")
            .where("phone", isEqualTo: await AuthServices().getUserPhone(u.uid))
            .get()
            .then((value2) async {
  ...
  Future<UserModel> getUser() async {
    final value = await AuthServices().getUser();
    user.value = value;
  ...
  subscribe() async {
    ...
    FirebaseFirestore.instance
        .collection("users")
        .where("phone", isEqualTo: user.value.phone)
        .get()
        .then((value) {
      FirebaseFirestore.instance
          .collection("sections")
          .where("title", isEqualTo: "محترف")
          .get()
          .then((value2) async {
